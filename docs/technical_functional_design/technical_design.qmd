...
2. **Dutch Houses Ingestion Process** – Known as the Data Ingestion System in [Chapter 3: System Scope and Context](#), effectively a sub-part of **Data Ingestion** for addresses and house imagery.  
...
Below, we illustrate the three main pipelines within the **Solardetection Service** via dynamic runtime diagrams. Each pipeline corresponds to a distinct process (data ingestion, training, and inference).  
